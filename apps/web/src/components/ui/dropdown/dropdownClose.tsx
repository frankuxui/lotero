...
export type DropdownCloseProps<T extends WithCommon = WithCommon> = {
  children: React.ReactElement<T>;
} & Partial<T>;

export function DropdownClose<T extends WithCommon = WithCommon>({ children, ...rest }: DropdownCloseProps<T>) {
